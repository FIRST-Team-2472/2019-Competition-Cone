...
public class Constants {
    ...
    public static final int CLIMB_REAR_FW_CHANNEL = -1;
    public static final int CLIMB_REAR_RV_CHANNEL = -1;
    public static final int CLIMB_FRONT_FW_CHANNEL = -1;
    public static final int CLIMB_FRONT_RV_CHANNEL = -1;
